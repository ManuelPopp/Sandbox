species_matrix <- function(df,
    ...
    #' @param taxon.col: A character string indicating the column which contains taxon names.
    #' @param sample.col: A character string indicating the column which contains sample IDs.
    #' @param abundance.col: A character string indicating the column which contains presense
    #' or abundance data.
    #' @param mode: Either "abundance" or "pa". Select whether the output is numeric or presence data.
    #' @param summarise: Either "mean" or "sum". Select how values are summarised in case multiple
    #' records exist for some combination of sample ID and taxon name.
